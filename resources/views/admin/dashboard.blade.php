    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="text-center card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-4"><strong>20</strong><br><i class="fas fa-folder-plus text-gray-400"></i> Laporan
                            Terkumpul</div>
                        <div class="col-4"><strong>12</strong><br><i class="fas fa-fire-alt text-gray-400"></i> Good</div>
                        <div class="col-4"><strong>9</strong><br><i class="fas fa-stethoscope text-gray-400"></i> Kurang
                            Fit</div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    SHIFT PEGAWAI</div> --}}
                            ...
                            <ul class="shift">
                                ...
                                <hr>
                                <li>M. Rizky Awaludin - <span class="status-good">Good</span></li>
                                <hr>
